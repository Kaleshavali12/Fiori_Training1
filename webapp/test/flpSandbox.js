		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "North wind Assignment",
									"targetURL": "#comodatanorthwindassignment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comodatanorthwindassignment-display": {
								"semanticObject": "comodatanorthwindassignment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.odata.northwindassignment",
									"url": sap.ui.require.toUrl("com/odata/northwindassignment")
								}
							}
						}
					}
